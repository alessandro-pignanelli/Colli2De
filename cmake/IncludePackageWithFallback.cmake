...
function(include_package_with_fallback PACKAGE_NAME LIB_DIR GIT_REPO VERSION USE_LOCAL_VAR)
    if (${USE_LOCAL_VAR})
        find_package(${PACKAGE_NAME} ${VERSION} REQUIRED PATHS ${CMAKE_SOURCE_DIR}/libs/${LIB_DIR}/install/${CMAKE_BUILD_TYPE})
    else()
        find_package(${PACKAGE_NAME} ${VERSION} QUIET PATHS ${CMAKE_SOURCE_DIR}/libs/${LIB_DIR}/install/${CMAKE_BUILD_TYPE})
