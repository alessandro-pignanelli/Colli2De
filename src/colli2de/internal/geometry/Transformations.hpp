...
{
private:
    constexpr Rotation(float angleRadians, float sin, float cos) : angleRadians(angleRadians),
                                                                   sin(sin),
                                                                   cos(cos)
    {}
...
public:
    ...
    constexpr Rotation(float angleRadians) : angleRadians(angleRadians),
    ...
    {
        return Rotation{ angleRadians + other.angleRadians,
