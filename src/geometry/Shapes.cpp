...
{
    C2D_DEBUG_ASSERT(halfWidth > 0.0f && halfHeight > 0.0f);
...
{
    C2D_DEBUG_ASSERT(n >= 3 && n <= MAX_POLYGON_VERTICES);
...
{
    C2D_DEBUG_ASSERT(points.size() >= 3 && points.size() <= MAX_POLYGON_VERTICES);
