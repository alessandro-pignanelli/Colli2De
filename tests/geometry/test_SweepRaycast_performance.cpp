...
TEST_CASE("Sweep raycast performance: Circle", "[Sweep][Benchmark][Raycast]")
{
    ...
    BENCHMARK_FUNCTION("Sweep raycast 10k circles",
                       5ms,
                       [&]()
                       {
                           uint32_t total = 0;
    ...
    BENCHMARK_FUNCTION("Sweep raycast 100k circles",
                       50ms,
                       [&]()
                       {
                           uint32_t total = 0;
...
TEST_CASE("Sweep raycast performance: Polygon", "[SweepRaycast][Benchmark][Polygon]")
{
    ...
    BENCHMARK_FUNCTION("Sweep raycast 10k polygons",
                       10ms,
                       [&]()
                       {
                           uint32_t total = 0;
    ...
    BENCHMARK_FUNCTION("Sweep raycast 100k polygons",
                       50ms,
                       [&]()
                       {
                           uint32_t total = 0;
